  ...
  <header class="header" data-header>
   ...
   <div class="header-bottom">
      <div class="container">
        ...
        <a href="#" class="logo">
          <img src="../img/logo.png" alt="Homeverse logo">
        </a>
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="exercice14.php" class="navbar-link" data-nav-link>Home</a>
              </li>

              <li>
                <a href="#" class="navbar-link" data-nav-link>Vendre</a>
              </li>

              <li>
                <a href="acheter.php" class="navbar-link" data-nav-link>Acheter</a>
              </li>

              <li>
                <a href="louer.php" class="navbar-link" data-nav-link>Louer</a>
              </li>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="../img/property-3.jpg" alt="Comfortable Apartment" class="w-100">
                  </a>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="../img/property-4.png" alt="Luxury villa in Rego Park" class="w-100">
                  </a>
